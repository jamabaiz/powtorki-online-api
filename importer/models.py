...
class Calendar:
    ...
    def __init__(self, id: int, date: int, tittle: str, note: str, calendar_set: str, date_text: str, module: int,
...
class Chapters:
    ...
    no_order: int
    visible: int
    date_enable: datetime
    shop_link: None
    epoch: str

    def __init__(self, id: int, name: str, description: None, no_order: int, visible: int, date_enable: datetime,
                 shop_link: None, epoch: str) -> None:
        self.id = id
        self.name = name
        self.description = description
        self.no_order = no_order
        self.visible = visible
        self.date_enable = date_enable
...
class Image:
    ...
    def __init__(self, id: int, id_str: str, source: str, tittle: None, copyright: None, time_creation: datetime,
                 time_edited: datetime) -> None:
        self.id = id
        self.id_str = id_str
        self.source = source
...
class MindMap:
    ...
    def __init__(self, id: int, name: str, document: int, time_creation: datetime, time_edited: datetime,
                 module: int) -> None:
        self.id = id
        self.name = name
        self.document = document
